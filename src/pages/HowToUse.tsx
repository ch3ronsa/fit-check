...
const HowToUse: React.FC = () => {
    ...
    const builtInFrameCount = FRAMES.filter((frame) => frame.path !== null).length;
    ...
    const steps = [
        ...
        },
        {
            ...
            description: `Browse ${builtInFrameCount} built-in digital frames. Each frame gives your photo a unique look, from minimalist to bold designs.`,
        },
        {
            icon: <Palette className="w-8 h-8 text-purple-400" />,
            title: '3. Apply Filter',
            description: `Choose from ${filterCount} filters, including Original, B&W, Vintage, Contrast, Cyber, and more. Find the perfect vibe for your fit.`,
        },
        {
            ...
            <div className="max-w-lg mx-auto">
                ...
                <div className="mt-8 p-5 rounded-2xl bg-gray-800/30 border border-gray-700/50">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                        <div className="flex items-center gap-2">
                            ...
                            <span>{builtInFrameCount} Frames</span>
                        </div>
                        <div className="flex items-center gap-2">
                ...
                <div className="mt-6 p-5 rounded-2xl bg-gradient-to-r from-base-blue/10 to-purple-500/10 border border-base-blue/20">
                    ...
                    <ul className="text-sm text-gray-300 space-y-2">
                        ...
                        <li>- Try different frame and filter combos for unique looks.</li>
                    </ul>
                </div>
